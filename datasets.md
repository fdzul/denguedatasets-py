...
**Licence** GNU General Public Licence v3.0 (GPL-3.0)

denguedatasets is free software distribuited under the terms of the GNU General Public Licence v3.0

## Datasets included in denguedatasets

This file documents the origin and license of each dataset included
in the **denguedatasets** Python package.
...
Title: Dengue Dataset of Bangladesh. Unraveling Dengue: Analyzing and Mapping Affected Areas in Bangladesh for Target
License: CC BY 4.0
Original Name: dataset.csv
Final Name: dengue_bangladesh.csv
...
Title: Climatic Influence on Dengue Mortality (2000-2024). Effects of climatic factors for increasing the risk of Dengue cases
License: MIT
Original Name: Climatic_Influence_on_Dengue_Mortality.csv
Final Name: dengue_bangladesh_mortality.csv
...
Title: Philippines Dengue Cases 2016-2020
License: CC0: Public Domain
Original Name: ph_dengue_cases2016-2020.csv
Final Name: dengue_philippines.csv
...
Title: Taiwan Dengue Cases 1998-2024. Daily and Regional Confirmed Cases of Dengue from 1998 to 2024
License: CC0: Public Domain
Original Name: Dengue_Daily_EN.csv
Final Name: dengue_taiwan.csv
...
Title: Sri Lanka Dengue Cases 2010 - 2020
License: Data files © Original Authors
Original Name: Dengue_Data(2010-2020).csv
Final Name: dengue_sri_lanka.csv
...
Title: Brazil Dengue Dataset 2000-2019. Brazil Dengue Dataset offers insights into geography, environment, and disease.
License: GPL 2
Original Name: data_2000_2019.csv
Final Name: dengue_brazil.csv
...
Source: Kaggle
URL: https://www.kaggle.com/datasets/raomuhammadsaeedali/brazil-dengue-dataset-2000-2019
Title: Brazil Dengue Dataset 2000-2019 — Data Dictionary
License: GPL 2
Original Name: data_desc.csv
Final Name: dengue_brazil_labels.csv
Description: Data dictionary/variable-label reference table accompanying the Brazil Dengue Dataset 2000-2019, documenting field names, codes, and descriptions used across microregion, mesoregion, state, region, biome, and ecozone identifiers, as well as climatic and demographic variables in the main dataset.
...
Title: Dengue Tabular Data of Medellin
License: Unknown
Original Name: Dengue_Dataset(Medellin).csv
Final Name: dengue_colombia_medellin.csv
...
Source: Kaggle
URL: https://www.kaggle.com/datasets/davidrestrepo/dengue
Title: Dengue Tabular Data of Colombia
License: Unknown
Original Name: dengue_data_all_municipalities.csv
Final Name: dengue_colombia.csv
Description: Dengue challenge 2- Make Health LATAM 2022. En este reto se proveerá de un dataset para cada municipio de Colombia, compuesto por los casos de dengue semana a semana entre 2007 y 2019, acompañado de otras variables sociales y climatológicas. Encontrarás además un dataset especial que hemos preparado para el municipio de Medellín, con variables climatológicas preprocesadas y una versión comprimida de imágenes satelitales para incluir en los modelos
...
Title: Sri Lanka Dengue Data: 2019-2021 Insights
License: CC0: Public Domain
Original Name: dengue_2019.csv
Final Name: dengue_sri_lanka_2019.csv
...
Title: Sri Lanka Dengue Data: 2019-2021 Insights
License: CC0: Public Domain
Original Name: dengue_2020.csv
Final Name: dengue_sri_lanka_2020.csv
Description: A comprehensive record of dengue cases across all districts and provinces in Sri Lanka, detailing monthly occurrences from January to December for the years 2019-2021.Data serves as a critical resource for understanding the epidemiological trends of dengue, facilitating public health responses and preventive strategies. Though compact, this dataset offers rich opportunities for data science applications including trend analysis, hot spot detection, and predictive modeling for future outbreaks. Data was meticulously compiled and made available by the National Dengue Control Unit (NDCU) of Sri Lanka. For more details, visit the NDCU Dengue Information Portal.
...
Title: Sri Lanka Dengue Data: 2019-2021 Insights
License: CC0: Public Domain
Original Name: dengue_2021.csv
Final Name: dengue_sri_lanka_2021.csv
Description: A comprehensive record of dengue cases across all districts and provinces in Sri Lanka, detailing monthly occurrences from January to December for the years 2019-2021.Data serves as a critical resource for understanding the epidemiological trends of dengue, facilitating public health responses and preventive strategies. Though compact, this dataset offers rich opportunities for data science applications including trend analysis, hot spot detection, and predictive modeling for future outbreaks. Data was meticulously compiled and made available by the National Dengue Control Unit (NDCU) of Sri Lanka. For more details, visit the NDCU Dengue Information Portal.
...
Title: Pakistan Dengue Surveillance Data (2016-2020)
License: CC BY-SA 4.0
Original Name: dengue_data.csv
Final Name: dengue_pakistan.csv
...
Title: Dengue Cases in India
License: CC0: Public Domain
Original Name: dengue_cases_in_india.csv
Final Name: dengue_india.csv
...
Title: Datos Dengue en el Perú 2019-2022 en CSV
License: Apache 2.0
Original Name: datos_dengue_TF.csv
Final Name: dengue_peru.csv
...
Title: Jakarta Dengue Cases and Weather Data, 2021-2024.
License: Unknown
Original Name: jakarta-dengue-weather_2021-2024.csv
Final Name: dengue_jakarta.csv
Description: No description available
...
Title: Sierra Leone Freetown DengueAI Dataset (2015–2024).
License: CC BY-SA 4.0
Original Name: SierraLeone_Freetown_DengueAI_Data.csv
Final Name: dengue_sierra_leone.csv
Description: Sierra Leone Freetown DengueAI Dataset (2015–2024) Overview The Sierra Leone Freetown DengueAI Dataset (2015–2024) offers an integrated collection of epidemiological and climatic variables, specifically designed for AI-based dengue outbreak prediction and time-series modeling. The dataset captures monthly variations in temperature, humidity, and precipitation, as well as confirmed dengue cases in Freetown, Sierra Leone. Data Sources Source Description Access OpenDengue (2024) Dengue case surveillance data collected across multiple countries. https://opendengue.org NOAA GSOD (Global Surface Summary of the Day, 2024) Daily climatic records (temperature, humidity, precipitation) aggregated to monthly averages. https://www.ncei.noaa.gov/data/global-summary-of-the-day/ This dataset is suitable for: Time series forecasting (short-, medium-, and long-term), Machine learning and deep learning models (LSTM, GRU, Transformer), Epidemiological trend analysis, AI-based health decision-support systems Data Preparation Notes, Climate data were aggregated monthly using mean or sum, depending on the variable. Missing values were linearly interpolated. All features were scaled using Minmax normalization during modeling. Outliers were visually inspected and corrected using monthly climatology references. Example Research Applications. Hybrid BiLSTM–Transformer models for dengue prediction. Explainable AI frameworks for outbreak interpretation. Climate–epidemic interaction studies in West Africa. Citation If you use this dataset in your work, please cite it as follows: Michael Marko Sesay. (2025). Sierra Leone Freetown DengueAI Dataset (2015–2024) [Data set]. Kaggle. https://doi.org/10.34740/KAGGLE/DSV/13257213 License CC BY 4.0 Acknowledgements This dataset integrates openly available data from OpenDengue and NOAA GSOD. Credit to all contributors who maintain these valuable public health and climate data repositories.
